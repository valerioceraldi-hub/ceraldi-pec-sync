...
def sync():
    ...
    with imaplib.IMAP4_SSL(PEC_HOST, PEC_PORT) as imap:
        ...
        # ── SELEZIONE CARTELLA ──
        # Cerca tutte le cartelle disponibili e identifica quella con le fatture.
        # Non ci fermiamo alla prima che risponde OK — INBOX risponde sempre OK
        # ma di solito non contiene le fatture elettroniche.
        # Strategia: prova prima i nomi noti, poi cerca la cartella con più email.
        cartella_selezionata = None
        max_email = 0

        # Prima prova i nomi canonici (con e senza virgolette)
        nomi_da_provare = [
        ...
        # Se non trovata, scansiona TUTTE le cartelle e prendi quella con più email
        if not cartella_selezionata or max_email == 0:
            ...
            for folder_item in (folder_list or []):
                ...
                # Estrai il nome della cartella (ultima parte dopo le virgolette o spazi)
