...
def estrai_prezzi_da_xml(xml_bytes, fattura_info):
    ...
    # Salta documenti senza prezzi acquisto: note credito/debito e autofatture
    if tipo_doc in ("nota_credito", "nota_debito", "autofattura"):
        log.info(f"  [prezzi] {tipo_doc} — skip")
        return 0
...
def parse_xml(xml_bytes):
    ...
    # Mappa completa codici SDI — aggiornata spec. tecniche v1.9
    # Note credito/debito: TD04, TD05, TD08, TD09
    # Fatture differite: TD24, TD25 — SONO FATTURE, non note credito
    # Autofatture: TD16-TD23, TD29
    TD_MAP = {
        "TD01":"fattura", "TD02":"fattura", "TD03":"fattura", "TD06":"fattura",
        "TD07":"fattura", "TD24":"fattura_differita", "TD25":"fattura_differita",
        "TD26":"fattura", "TD27":"fattura", "TD28":"fattura",
    ...
    tipo = TD_MAP.get(tipo_doc, "fattura")
